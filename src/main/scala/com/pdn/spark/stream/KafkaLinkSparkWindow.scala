...
object KafkaLinkSparkWindow {
  def main(args: Array[String]): Unit = {
    ...
    val pairStream: DStream[(String, Int)] = words.map((_, 1))

    val windowStream: DStream[(String, Int)] = pairStream.reduceByKeyAndWindow((x:Int,y:Int)=>x+y, Seconds(10), Seconds(10))
